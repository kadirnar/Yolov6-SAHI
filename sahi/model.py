...
class DetectionModel:
    def __init__(
        ...
        self.image_size = check_img_size(img_size=self.image_size)
...
class Yolov6DetectionModel(DetectionModel):
    def load_model(self):
    ...
    def _create_object_prediction_list_from_original_predictions(
        ...
        object_prediction_list_per_image = []
        object_prediction_list = []
        det = non_max_suppression(self._original_predictions, conf_thres=self.confidence_threshold, max_det=1000)[0]
        if len(det):
